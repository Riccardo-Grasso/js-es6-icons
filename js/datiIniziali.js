...
const filterSelect = document.querySelectorAll(".filter_select");
...
filterSelect.addEventListener("click", function () {
	...
	function stampaSingolaCategoria(listaDaStampare) {
		...
		for (let i = 0; i < listaDaStampare.length; i++) {

			const icon = listaDaStampare[i];
	...
	stampaSingolaCategoria(iconeRaggruppate.user);
});
